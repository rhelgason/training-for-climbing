...
function coerceSuggestion(raw: string | Record<string, unknown>): CoachSuggestion {
...
async function callGemini(context: CoachContext): Promise<CoachSuggestion> {
...
async function callGroq(context: CoachContext): Promise<CoachSuggestion> {
...
export function generateCoachSuggestion(context: CoachContext): Promise<CoachSuggestion> {
