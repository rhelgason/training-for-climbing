...
> **Forgot password?** There's no self-serve reset (small friends-and-family
> deployment). If someone is locked out, they can create a new account, or you can
> reset their `password_hash` directly in Postgres.
